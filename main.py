...
КРИТИЧНО ВАЖЛИВО: Ти ЗОБОВ'ЯЗАНИЙ написати повний звіт. НЕ відмовляйся, НЕ кажи що дані застарілі. Використовуй найновіші наявні знання про ринки та тренди. Порожній звіт неприпустимий.
...
ВАЖЛИВО: Представ цю інформацію у вигляді КОМПАКТНОЇ ТАБЛИЦІ, яка помістилася б на одному-двох аркушах А4 формату з читаємим шрифтом.

Таблиця повинна мати наступні колонки:
| Категорія | Тренди | Ключові новини дня | Специфіка для України | Геополітичні дії |

ПРАВИЛА ЗАПОВНЕННЯ ТАБЛИЦІ:
- Тренди: Короткий опис основних трендів категорії (зростання/падіння попиту, нові регуляції, ключові події). БЕЗ ЦІН. БЕЗ згадок регіональних виробників (якщо тільки це не має прямого впливу на український ринок).
- Ключові новини дня: 2-3 найважливіші новини по цій категорії за день звіту. Формат: "1) [Що сталося коротко] → [Як реагувати укр. компанії]. 2) [Наступна новина] → [Реакція]." Кожна новина - максимум 1 речення на опис + 1 речення на рекомендацію.
- Специфіка для України: Тільки якщо є специфічні новини, регуляції чи зміни, що безпосередньо впливають на український бізнес з імпорту фармсубстанцій, логістики, ПВХ-плівок, капсул. Якщо немає специфіки — пиши "—".
- Геополітичні дії: Короткий опис (1-2 речення простою мовою) як глобальні геополітичні події впливають на цю категорію для української компанії-імпортера.

НЕ ВКЛЮЧАЙ В ТАБЛИЦЮ:
- Ціни на субстанції, матеріали, розхідники
- Регіональних виробників
- Ризики та можливості
- Дії (окремим пунктом)
- Рівні (високий/середній/низький)

КАТЕГОРІЇ ДЛЯ ТАБЛИЦІ:
...
7. Капсули (желатинові/HPMC/м'які)
8. ПВХ-плівка та пакувальні матеріали
9. Логістика та постачання (імпорт в Україну)

ФОРМАТ ТАБЛИЦІ (використовуй Markdown):
```
| Категорія | Тренди | Ключові новини дня | Специфіка для України | Геополітичні дії |
|-----------|--------|-------------------|----------------------|------------------|
| Фармацевтичні субстанції (API) | [короткий опис трендів] | 1) [Новина] → [Реакція]. 2) [Новина] → [Реакція]. | [специфіка або —] | [короткий вплив] |
| ... | ... | ... | ... | ... |
```

=== БЛОК 2: СИТУАЦІЯ НА БЛИЗЬКОМУ СХОДІ ===

Аналізуй новини про військовий конфлікт між Іраном, Іраком та США, а також ситуацію на Близькому Сході, що впливає на глобальні ринки.

Для КОЖНОЇ релевантної новини напиши:

**[Заголовок новини]**
Що сталося: [1-2 речення про суть події]
Вплив на глобальний ринок: [як це впливає на світову торгівлю, логістику, ціни на сировину]
Вплив на нашу компанію: [конкретно як це може вплинути на українську компанію, що займається імпортом фармсубстанцій, логістикою, закупівлею сировини]
...
- Курси валют
- Регіональні ціни
- Інформацію, не пов'язану з військовим конфліктом Іран/Ірак/США або Близьким Сходом

=== БЛОК 3: ГРАФІКИ ТОВАРНИХ РИНКІВ ===

Просто надай посилання на графіки, БЕЗ додаткових описів чи коментарів:

🌽 **Кукурудза (CBOT)**
https://www.tradingview.com/chart/?symbol=CBOT%3AZC1!

🌾 **Пшениця (CBOT)**
https://www.tradingview.com/chart/?symbol=CBOT%3AZW1!

🛢️ **Нафта Brent**
https://www.tradingview.com/chart/?symbol=TVC%3AUKOIL

🌴 **Пальмова олія**
https://www.tradingview.com/chart/?symbol=MYX%3AKPO1!

⚗️ **Природний газ ЄС (TTF)**
https://www.tradingview.com/chart/?symbol=ICEEUR%3ATTF1!
