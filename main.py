...
async def generate_daily_pdf_report(mode: str = "daily_brief") -> str | None:
    ...
    if use_facts_path:
        ...
        # ── Hard rules: force model to use DB news, address Ukraine/EU ──
        _b2_hard_rules = (
            "ЖОРСТКІ ПРАВИЛА ДЛЯ БЛОКУ 2 — ПОРУШЕННЯ НЕПРИПУСТИМЕ:\n"
            "1. ВИКОРИСТОВУЙ ВИКЛЮЧНО факти з розділу НОВИНИ нижче.\n"
            "   ЗАБОРОНЕНО будь-що, чого немає в цих новинах.\n"
            ...
            "   спиратися на конкретний факт з наданих новин.\n"
            "   Якщо факту немає — речення не пиши взагалі.\n"
            "3. ЦИФРИ — тільки ті, що є в новинах (ціни, %, дати, обсяги).\n"
            ...
            "   'Як ця конкретна новина впливає на роботу нашої компанії в Україні/ЄС?'\n"
            "5. Структура memo (всі секції обов'язкові якщо є факти):\n"
            "   **Заголовок:** [конкретна подія з новин + наслідок для ЄС/України]\n"
            "   **Короткий висновок:** [що сталося за новинами → вплив на ЄС/Україну → дія]\n"
            "   **Що сталося:** [тільки факти з новин: хто, що, коли, цифри]\n"
            "   **Вплив на енергетику Європи:** [як ці новини змінюють енергоринок ЄС]\n"
            ...
            "   **Прогноз на 2-3 тижні:** [на основі трендів з новин]\n"
        ...
        # ── Hard rules for fallback path ────────────────────────────
        _memo_b2_structure_fb = (
            "ЖОРСТКІ ПРАВИЛА ДЛЯ БЛОКУ 2:\n"
            "1. ВИКОРИСТОВУЙ ВИКЛЮЧНО новини з розділу НОВИНИ нижче.\n"
            "   ЗАБОРОНЕНО писати будь-що, чого немає в цих новинах.\n"
            "2. КОЖНЕ речення МУСИТЬ спиратися на конкретний факт з наданих новин.\n"
            "3. ЦИФРИ — тільки ті, що є в новинах. ЗАБОРОНЕНО вигадувати цифри.\n"
            "4. АУДИТОРІЯ — українські та європейські B2B компанії-імпортери.\n"
            "   Кожен висновок відповідає: 'Як ця новина впливає на нашу компанію в Україні/ЄС?'\n"
            "5. Структура:\n"
            "   **Заголовок:** [конкретна подія + наслідок для ЄС/України]\n"
            "   **Короткий висновок:** [що сталося → вплив на ЄС/Україну → дія]\n"
            "   **Що сталося:** [факти з новин: хто, що, коли, цифри]\n"
            "   **Вплив на енергетику Європи:** [як ці новини змінюють енергоринок ЄС]\n"
            "   **Вплив на торгівлю та логістику ЄС і України:** [фрахт, маршрути, затримки]\n"
            "   **Що це означає конкретно для нашої компанії:** [ціни, терміни, ризики]\n"
            "   **Практичні рекомендації:** [5-7 конкретних дій ЗАРАЗ]\n"
            "   **Прогноз на 2-3 тижні:** [на основі трендів з новин]\n"
            "   **Фінальний висновок для керівництва:** [одне речення]\n"
            "   **Джерела:** [список як надано]\n"
        )
